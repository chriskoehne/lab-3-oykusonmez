public class StringUtils {
    ...
    public static String makePurdueUsername(String firstName, String lastName) {
        ...
        res = firstName.substring(0,1).toLowerCase() + lastName.substring(0, lastName.length()).toLowerCase();

        }

        else {

            res = firstName.substring(0, 1).toLowerCase() + lastName.substring(0, 7).toLowerCase();
